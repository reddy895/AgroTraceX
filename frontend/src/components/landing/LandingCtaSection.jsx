      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
        <div className="ag-glass rounded-3xl p-8 sm:p-14 lg:p-16 border border-white/15 text-center max-w-4xl mx-auto space-y-6 shadow-[0_20px_60px_rgba(0,0,0,0.8)]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4 font-mono">
            <Link
              to="/signup"
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-white text-black font-semibold text-xs sm:text-sm uppercase tracking-wider hover:bg-neutral-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.35)] active:scale-[0.98]"
            >
          ...
          <div className="pt-6 border-t border-white/10 flex flex-wrap items-center justify-center gap-6 text-3xs font-mono text-neutral-500">
            <span>SOC2 TYPE II CERTIFIED</span>
            <span>•</span>
            <span>GLP TRIAL STANDARDS</span>
            <span>•</span>
